...
steps:
  ...
  - title: Cuisson du bœuf.
    body: Sur le grill très chaud, griller le morceau de bœuf 30 secondes sur chaque face. Stopper la cuisson puis badigeonner immédiatement avec un mélange de sauce teriyaki, de sauce soja et quelques gouttes de jus de citron jaune.
  - title: Dressage.
...
tips:
  - title: Assaisonnez après, pas avant
    body: Pour la viande rouge, François Jagut assaisonne toujours après la cuisson. Le sel avant forme une croûte qui coagule les protéines (le sang reste à l’intérieur).
